...
namespace genscoSQLProject1.Interfaces
{
    public interface IAssetItemsRepository
    {
        ...
        AssetItems GetAssetItems(int checklistItemId, int assetId, int branchInspectionId);
        ICollection<AssetItems> GetAssetItemsByAsset(int assetId);
        ICollection<AssetItems> GetAssetItemsByBranchInspection(int branchInspectionId);

        bool AssetItemsExists(int checklistItemId, int assetId, int branchInspectionId);
